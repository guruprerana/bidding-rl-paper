...
In the environments we consider, the optimization metric is the cumulative reward across objectives and so we define the \textit{global} reward as \(w(\rho)=\sum_{i=1}^m w_i(\rho)\).
