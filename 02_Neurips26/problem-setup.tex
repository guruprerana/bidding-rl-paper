...
In both settings, the highest bidder's actions get executed for $\tau$ consecutive steps, with bidding ties resolved uniformly at random.
...
The penalties force policies to select their bids to reflect how critical their action is in the current state.
...
We formulate our framework as a general-sum game between multiple policies.
