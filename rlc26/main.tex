...
\contribution{
    % Contribution
    We present a novel, interpretable framework for designing adaptive RL policies for multi-objective problems in which objectives are drawn from the same family (here, discounted cumulative reward), they may appear or disappear during runtime, and an arbitrary number of them may be active at any time.
    }
    {
    % Caveat/Context:
    None
...
\summary{
We consider multi-objective reinforcement learning problems where objectives come from an identical family---such as discounted cumulative reward or reachability---and may appear or disappear at runtime.
...
\KM{Looking at the title again, ``auction-based'' sounds nicer than ``bidding-based''}
