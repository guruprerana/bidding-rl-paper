...
This motivates future study that attempts using different mechanisms like majority voting---which would result in the optimal action in the example above.
