...
Given an \mabmdp~\(\mathcal{B}_{\mathcal{M}}\), a \textit{policy} for each agent indexed by \(i \in \{1, \dots, m\}\) takes a similar form \(\pi_i : (\hat S \times \hat A)^* \times \hat S \to \hat A\).
