...
We formalize this approach by viewing the \momdp as an \(m\)-player general-sum Markov game~\citep{littman1994markov} in which \(m\) players, one corresponding to each objective, compete with each other to take control of the agent and maximize their objectives. We define the game as follows:
